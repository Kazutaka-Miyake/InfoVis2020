function Isosurfaces( volume, isovalue )
{
   ...
   // material.color =  new THREE.Color().setHex( cmap[ 128] );
    ...
    //material.color = new THREE.Color( cmap[isovalue] );
    //material.color = new THREE.Color( cmap[ 64][1] );
    ...
    {
        if(v0[1]<v1[1])
          var v0_2  = v0[1] *  (s - v1[1])/(v0[1] - v1[1]);
        else
          var v0_2  = v1[1] *  (s - v0[1])/(v1[1] - v0[1]);

        return new THREE.Vector3(v0[0],v0_2 ,v0[2]);
    }
}